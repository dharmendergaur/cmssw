...
L1TPFJetsPhase1Task_9x9trimmed = cms.Task(  Phase1L1TJetProducer9x9trimmed, Phase1L1TJetCalibrator9x9trimmed, Phase1L1TJetSumsProducer9x9trimmed)
...
_phase2_siml1emulator.add(l1PFJetsEmulationTask)
