...
process.l1tTrackerEtMiss.L1VertexInputTag = cms.InputTag(producerName,"l1tVertices")
...
process.l1tTrackerEmuEtMiss.L1VertexInputTag = cms.InputTag(EmuproducerName,"l1tVerticesEmulation")
